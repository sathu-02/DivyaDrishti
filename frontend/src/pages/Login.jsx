    ...
    return (
        <div style={{ position: 'fixed', inset: 0, zIndex: 1000, backgroundColor: '#ffffff', padding: '0.5rem', display: 'flex', overflow: 'auto' }}>
            <div style={{
                flex: 1,
                borderRadius: '24px',
                background: 'radial-gradient(circle at 50% 50%, #fffcf5 0%, #f4e8d3 100%)',
                display: 'flex',
                ...
                <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, overflow: 'hidden', pointerEvents: 'none', zIndex: 0 }}>
                    <svg viewBox="0 0 1440 800" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ position: 'absolute', top: '10%', left: '-10%', width: '120%', height: 'auto', opacity: 0.15 }}>
                        ...
                        <path d="M-100 240 C 400 440, 800 -60, 1500 340" stroke="#a88d6b" strokeWidth="1" />
                        <path d="M-100 260 C 400 460, 800 -40, 1500 360" stroke="#a88d6b" strokeWidth="1" />
                        ...
                        <path d="M-100 440 C 500 140, 900 640, 1500 240" stroke="#a88d6b" strokeWidth="1" />
                        <path d="M-100 460 C 500 160, 900 660, 1500 260" stroke="#a88d6b" strokeWidth="1" />
                    </svg>
                </div>
                ...
                <main style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', position: 'relative', zIndex: 10 }}>
                    <div style={{ background: '#fcfaf4', borderRadius: '16px', padding: '3rem 2rem', width: '100%', maxWidth: '400px', boxShadow: '0 8px 32px rgba(30,64,99,0.1)', border: '1px solid #efeadd' }}>
                        <h2 style={{ fontFamily: '"Inter", sans-serif', fontSize: '1.5rem', fontWeight: '700', color: '#1e4063', textAlign: 'center', marginBottom: '2rem' }}>Welcome Back</h2>
                        ...
                        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                            <input
                                id="email"
                                type="email"
                                style={{ background: '#f4e9d5', border: '1px solid #e2d3b9', padding: '1rem 1.2rem', borderRadius: '12px', fontSize: '1rem', color: '#1e4063', outline: 'none' }}
                                value={email}
                            ...
                            <button type="submit" disabled={loading} style={{ background: '#1e4063', color: 'white', padding: '1rem', borderRadius: '50px', fontWeight: '500', fontSize: '1rem', marginTop: '1rem', cursor: loading ? 'not-allowed' : 'pointer', opacity: loading ? 0.7 : 1 }}>
